...
import "./ProspectQuestionairre.scss";
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-content">
          ...
          >
            ...
            <div className="form-group">
              <label htmlFor="financialGoals">
                What are your primary financial objectives for the next 1-3 years?
              </label>
              <textarea
                id="financialGoals"
          ...
          >
            ...
            <div className="form-group">
              <label htmlFor="budgetRange">Expected Budget Range (Optional)</label>
              <select
                id="budgetRange"
